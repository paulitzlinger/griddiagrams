...
A complete list of all suitable grid diagrams of fibered knots that were found using this program can be found [on my webpage](https://paulitzlinger.github.io).
